//
//  ImageMapWithScrollViewController.swift
//  MetroforApp
//
//  Created by Adolfho Athyla on 30/08/15.
//  Copyright (c) 2015 Adolfho Athyla. All rights reserved.
//

import UIKit

class ImageMapWithScrollViewController: UIViewController, UIScrollViewDelegate {
    ...
    func updateConstraints() {
        if let image = imageView.image {
            ...
            let imageHeight = image.size.height+150
