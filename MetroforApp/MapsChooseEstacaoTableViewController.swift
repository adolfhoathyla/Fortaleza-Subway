//
//  MapsChooseEstacaoTableViewController.swift
//  MetroforApp
//
...
class MapsChooseEstacaoTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        var linhas = ManagerData.getAllLinhas()
        
        for linha in linhas {
            self.objects.append(linha.nome)
        }
        self.objects.append("Geral")
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "showImageMap" {
            if let indexPath = self.tableView.indexPathForSelectedRow() {
                let showImageViewController = segue.destinationViewController as! ImageMapWithScrollViewController
